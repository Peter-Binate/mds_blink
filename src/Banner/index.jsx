...
export default function Banner() {
  return (
    <div 
      className="text-center md:px-custom-padding" 
    >
      <h2 className="uppercase text-3xl font-bold pt-20 mb-14">phrase d'accroche ou slogan</h2>
      <h3 className="mb-4 capitalize text-xl">titre paragraphe</h3>
      ...
      <button className="mb-20 uppercase bg-red-400 text-white duration-500 md:w-2/5 px-12 hover:bg-red-500 rounded-full h-16">
